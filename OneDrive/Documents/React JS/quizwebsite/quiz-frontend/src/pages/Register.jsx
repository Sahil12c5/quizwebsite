...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:8080/quiz-backend/api/auth/register', {
                username,
                password,
                email
            });
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden font-body">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                <div className="absolute top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-indigo-200 filter blur-[100px] opacity-50"></div>
                <div className="absolute -bottom-[20%] -right-[10%] w-[40%] h-[40%] rounded-full bg-purple-200 filter blur-[100px] opacity-50"></div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-full max-w-md border border-white/50 z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500">Join DevQuiz and start learning</p>
                </div>
